...
public:
    ...
    void setupUi(QMainWindow *MainWindowClass)
    {
        ...
        MainWindowClass->resize(1034, 703);
        ...
        layoutWidget->setGeometry(QRect(520, 470, 501, 161));
    ...
    void retranslateUi(QMainWindow *MainWindowClass)
    {
        ...
        pushButton->setText(QApplication::translate("MainWindowClass", "Show on the way", Q_NULLPTR));
