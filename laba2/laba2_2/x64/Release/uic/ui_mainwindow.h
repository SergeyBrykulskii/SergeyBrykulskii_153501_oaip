...
public:
    ...
    void setupUi(QMainWindow *MainWindowClass)
    {
        ...
        MainWindowClass->setMinimumSize(QSize(600, 600));
        MainWindowClass->setMaximumSize(QSize(600, 600));
        centralWidget = new QWidget(MainWindowClass);
        centralWidget->setObjectName(QStringLiteral("centralWidget"));
        listTable = new QTableWidget(centralWidget);
        listTable->setObjectName(QStringLiteral("listTable"));
        listTable->setGeometry(QRect(25, 11, 201, 401));
        layoutWidget = new QWidget(centralWidget);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(300, 50, 251, 51));
        horizontalLayout = new QHBoxLayout(layoutWidget);
        horizontalLayout->setSpacing(6);
        horizontalLayout->setContentsMargins(11, 11, 11, 11);
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        push = new QPushButton(layoutWidget);
        push->setObjectName(QStringLiteral("push"));

        horizontalLayout->addWidget(push);

        pop = new QPushButton(layoutWidget);
